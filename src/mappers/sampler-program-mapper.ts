...
export class SamplerInMemoryProgramMapper
  extends SamplerMapperBase
  implements SamplerHeaderMapper<Program>
{
  ...
  mapToSysexData(program: Program): number[] {
    ...
    this.convertNameToSamplerSysexName(program.name).forEach(
      (value, index) => (data[3 + index] = value),
    );
    ...
    data[26] = this.convertFromPlusOrMinusFifty(
      program.masterOutput.loudnessModulationInput1Amount,
    );
    ...
    data[40] = this.convertFromPlusOrMinusTwelve(
      program.pitchBend.pressureModulation,
    );
    ...
    data[45] = this.convertFromPlusOrMinusFifty(
      program.semiToneTuning.temperCSharp,
    );
    data[46] = this.convertFromPlusOrMinusFifty(program.semiToneTuning.temperD);
    data[47] = this.convertFromPlusOrMinusFifty(
      program.semiToneTuning.temperDSharp,
    );
    ...
    data[50] = this.convertFromPlusOrMinusFifty(
      program.semiToneTuning.temperFSharp,
    );
    data[51] = this.convertFromPlusOrMinusFifty(program.semiToneTuning.temperG);
    data[52] = this.convertFromPlusOrMinusFifty(
      program.semiToneTuning.temperGSharp,
    );
    data[53] = this.convertFromPlusOrMinusFifty(program.semiToneTuning.temperA);
    data[54] = this.convertFromPlusOrMinusFifty(
      program.semiToneTuning.temperASharp,
    );
    ...
    const result = this.convertFromPlusOrMinusFiftyIncludingFraction(
      program.masterTuning.tune,
    );
    data[65] = result[0];
    data[66] = result[1];
    ...
    data[89] = this.convertFromPlusOrMinusFifty(
      program.masterPan.panModulationInput1Amount,
    );
    data[90] = this.convertFromPlusOrMinusFifty(
      program.masterPan.panModulationInput2Amount,
    );
    data[91] = this.convertFromPlusOrMinusFifty(
      program.masterPan.panModulationInput3Amount,
    );

    data[92] = this.convertFromPlusOrMinusFifty(
      program.masterOutput.loudnessModulationInput2Amount,
    );
    data[93] = this.convertFromPlusOrMinusFifty(
      program.masterOutput.loudnessModulationInput3Amount,
    );

    data[94] = this.convertFromPlusOrMinusFifty(
      program.lfo1.speedModulationInputAmount,
    );
    data[95] = this.convertFromPlusOrMinusFifty(
      program.lfo1.depthModulationInputAmount,
    );
    data[96] = this.convertFromPlusOrMinusFifty(
      program.lfo1.delayModulationInputAmount,
    );
  ...
  public mapFromSysexData(data: Array<number>): Program {
    ...
    this.mapFromSysexDataUsingExistingProgram(data, program);

    return program;
  }

  public mapFromSysexDataUsingExistingProgram(
    data: Array<number>,
    program: Program,
  ) {
    ...
    program.pitchBend.pressureModulation = this.convertToPlusOrMinusTwelve(
      data[40],
    );
    ...
    program.semiToneTuning.temperCSharp = this.convertToPlusOrMinusFifty(
      data[45],
    );
    program.semiToneTuning.temperD = this.convertToPlusOrMinusFifty(data[46]);
    program.semiToneTuning.temperDSharp = this.convertToPlusOrMinusFifty(
      data[47],
    );
    ...
    program.semiToneTuning.temperFSharp = this.convertToPlusOrMinusFifty(
      data[50],
    );
    program.semiToneTuning.temperG = this.convertToPlusOrMinusFifty(data[51]);
    program.semiToneTuning.temperGSharp = this.convertToPlusOrMinusFifty(
      data[52],
    );
    program.semiToneTuning.temperA = this.convertToPlusOrMinusFifty(data[53]);
    program.semiToneTuning.temperASharp = this.convertToPlusOrMinusFifty(
      data[54],
    );
    ...
    program.masterTuning.tune = this.convertToPlusOrMinusFiftyIncludingFraction(
      data[66],
      data[65],
    );
    ...
    program.masterPan.panModulationInput1Type =
      this.convertSampleSysexModulationSourceType(data[76]);
    program.masterPan.panModulationInput2Type =
      this.convertSampleSysexModulationSourceType(data[77]);
    program.masterPan.panModulationInput3Type =
      this.convertSampleSysexModulationSourceType(data[78]);

    program.masterOutput.loudnessModulationInput2Type =
      this.convertSampleSysexModulationSourceType(data[79]);
    program.masterOutput.loudnessModulationInput3Type =
      this.convertSampleSysexModulationSourceType(data[80]);

    program.lfo1.speedModulationInputType =
      this.convertSampleSysexModulationSourceType(data[81]);
    program.lfo1.depthModulationInputType =
      this.convertSampleSysexModulationSourceType(data[82]);
    program.lfo1.delayModulationInputType =
      this.convertSampleSysexModulationSourceType(data[83]);

    program.filter1FreqModulationInput1Type =
      this.convertSampleSysexModulationSourceType(data[84]);
    program.filter1FreqModulationInput2Type =
      this.convertSampleSysexModulationSourceType(data[85]);
    program.filter1FreqModulationInput3Type =
      this.convertSampleSysexModulationSourceType(data[86]);

    program.pitchModulationInputType =
      this.convertSampleSysexModulationSourceType(data[87]);

    program.loudnessModulationInputType =
      this.convertSampleSysexModulationSourceType(data[88]);

    program.masterPan.panModulationInput1Amount =
      this.convertToPlusOrMinusFifty(data[89]);
    program.masterPan.panModulationInput2Amount =
      this.convertToPlusOrMinusFifty(data[90]);
    program.masterPan.panModulationInput3Amount =
      this.convertToPlusOrMinusFifty(data[91]);

    program.masterOutput.loudnessModulationInput2Amount =
      this.convertToPlusOrMinusFifty(data[92]);
    program.masterOutput.loudnessModulationInput3Amount =
      this.convertToPlusOrMinusFifty(data[93]);

    program.lfo1.speedModulationInputAmount = this.convertToPlusOrMinusFifty(
      data[94],
    );
    program.lfo1.depthModulationInputAmount = this.convertToPlusOrMinusFifty(
      data[95],
    );
    program.lfo1.delayModulationInputAmount = this.convertToPlusOrMinusFifty(
      data[96],
    );
    ...
    program.filter2FreqModulationInput1Type =
      this.convertSampleSysexModulationSourceType(data[99]);
    program.filter2FreqModulationInput2Type =
      this.convertSampleSysexModulationSourceType(data[100]);
    program.filter2FreqModulationInput3Type =
      this.convertSampleSysexModulationSourceType(data[101]);

    program.lfo2.retrigger = data[102];

    program.portamento.rate = data[110];
    program.portamento.type =
      data[111] == 0 ? PortamentoType.RATE : PortamentoType.TIME;
